    ...
    return (
        <div className=' flex justify-center items-center h-screen w-full bg-cover bg-no-repeat overflow-x-hidden' style={{ backgroundImage: `url(${bgImage})` }}>
            <div className='flex justify-center shadow-[0_0_8px_black] rounded-3xl object-center bg-black/50  w-[600px] max-w-full min-[700px]:max-[1030px]:w-[600px] max-[500px]:h-screen sm:h-screen max-[500px]:rounded-none  md:h-1/2 relative'>
                ...
                <input type="text" placeholder={seller?seller:"shop name"} className="w-[260px] h-8 absolute top-[50px] max-w-full rounded-2xl border-2 focus:border-black focus:scale-105 max-[500px]:w-[180px] max-[500px]:left-[130px] max-[500px]:text-md max-[500px]:top-[100px] " onChange={(e) => setShop(e.target.value)}></input>
               ...
               {showRules == true ? null : (<> <label className="absolute top-[130px] left-[10px] text-white text-lg font-semibold max-w-full max-[500px]:top-[180px]">{seller=="username"?"Address":"Shop address"}:</label>
                <input type="text" placeholder="Street" className="w-[260px] max-w-full h-8 absolute top-[130px] rounded-2xl border-2 focus:border-black focus:scale-105 max-[500px]:w-[180px] max-[500px]:left-[130px] max-[500px]:text-md max-[500px]:top-[180px]" onChange={(e) => setStreet(e.target.value)} />
                <input type="text" placeholder="City" className="w-[260px] max-w-full h-8 absolute top-[170px] rounded-2xl border-2 focus:border-black focus:scale-105 max-[500px]:w-[180px] max-[500px]:left-[130px] max-[500px]:text-md max-[500px]:top-[220px]" onChange={(e) => setCity(e.target.value)} />
                <input type="text" placeholder="State" className="w-[260px] max-w-full h-8 absolute top-[210px] rounded-2xl border-2 focus:border-black focus:scale-105 max-[500px]:w-[180px] max-[500px]:left-[130px] max-[500px]:text-md max-[500px]:top-[260px]" onChange={(e) => setState(e.target.value)} />
                {state === "" ? <span className="text-white absolute top-[200px] right-[100px] max-[500px]:right-[30px] max-[500px]:top-[260px] ">**</span> : null}
                <input type="text" placeholder="PIN Code" className="w-[260px] max-w-full h-8 absolute top-[250px] rounded-2xl border-2 focus:border-black focus:scale-105 max-[500px]:w-[180px] max-[500px]:left-[130px] max-[500px]:text-md max-[500px]:top-[300px]" onChange={(e) => setPin(e.target.value)} />{pin.length != 6 ? <span className="text-white absolute top-[240px] right-[100px] max-[500px]:right-[30px] max-[500px]:top-[300px] ">**</span> : null}
                ...
                <input type="text" placeholder="Mobile Number" className="w-[260px] max-w-full h-8 absolute top-[290px] rounded-2xl border-2 focus:border-black focus:scale-105 max-[500px]:w-[180px] max-[500px]:left-[130px] max-[500px]:text-md max-[500px]:top-[340px]" onChange={(e) => setMobile(e.target.value)} ></input>
